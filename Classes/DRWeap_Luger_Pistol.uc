class DRWeap_Luger_Pistol extends ROProjectileWeapon
    abstract;
...
defaultproperties
{
    WeaponContentClass(0)="DesertRats.DRWeap_Luger_Pistol_Content"

    RoleSelectionImage(0)=Texture2D'DR_UI.WP_Render.WP_Render_Luger'
    ...
    InstantHitDamageTypes(0)=class'DRDmgType_LugerBullet'
    InstantHitDamageTypes(1)=class'DRDmgType_LugerBullet'
