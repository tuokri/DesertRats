...
// Periscope / gun linkage.
var name GunnerCameraSocketName;
var SkeletalMeshSocket GunnerCameraSocket;
var ROSkelControl_TurretConstrained CachedTurretControl;
...
DefaultProperties
{
    ...
    */
    ...
    GunnerCameraSocketName=Camera_Gunner
        ...
        */
        ...
        (
            ...
            (
                ...
                bAllowFocus=false,
                PositionCameraTag=Camera_Periscope,
                ViewFOV=20.5,
                bRotateGunOnCommand=true,
                bViewFromCameraTag=true,
                bDrawOverlays=true,
                SeatProxyIndex=1,
                PositionDownAnim=Driver_port_idle,
                PositionUpAnim=Driver_port_idle,
                PositionIdleAnim=Driver_port_idle,
                DriverIdleAnim=Driver_port_idle,
                AlternateIdleAnim=Driver_port_idle,
                bConstrainRotation=false,
                YawContraintIndex=1,
                PitchContraintIndex=0,
                LeftHandIKInfo=(IKEnabled=false,DefaultEffectorLocationTargetName=IK_GunnerLeftHand,DefaultEffectorRotationTargetName=IK_GunnerLeftHand),
                RightHandIKInfo=(IKEnabled=false,DefaultEffectorLocationTargetName=IK_GunnerRightHand,DefaultEffectorRotationTargetName=IK_GunnerRightHand),
    ...
    Seats(2)={(
        GunClass=class'DRVWeap_ShermanIII_Turret',
        ...
        (
            (
                ...
                AlternateIdleAnim=Driver_port_idle,
                SeatProxyIndex=2,
                LeftHandIKInfo=(PinEnabled=false,IKEnabled=false),
                RightHandIKInfo=(PinEnabled=false,IKEnabled=false),
                HipsIKInfo=(PinEnabled=false),
                LeftFootIKInfo=(PinEnabled=false,IKEnabled=false),
                RightFootIKInfo=(PinEnabled=false,IKEnabled=false),
                PositionFlinchAnims=(Driver_port_idle),
                PositionDeathAnims=(Driver_open_Death)
            )
        ),
    ...
    Seats(3)={( GunClass=class'DRVWeap_ShermanIII_HullMG',
    ...
    Seats(4)={(bNonEnterable=true,
                ...
                SeatPositions=((bDriverVisible=false,PositionIdleAnim=Driver_port_idle,AlternateIdleAnim=Driver_port_idle,SeatProxyIndex=4,
                                    ...
                                    LeftHandIKInfo=(IKEnabled=false,
                                        AlternateEffectorTargets=((Action=DAct_CannonReload_LH1,IKEnabled=false,PinEnabled=false,EffectorLocationTargetName=LoaderLHCannon1,EffectorRotationTargetName=LoaderLHCannon1),
                                                                  (Action=DAct_CannonReload_LH2,IKEnabled=false,PinEnabled=false,EffectorLocationTargetName=LoaderLHCannon2,EffectorRotationTargetName=LoaderLHCannon2),
                                                                  (Action=DAct_CannonReload_LH3,IKEnabled=false,PinEnabled=false,EffectorLocationTargetName=LoaderLHCannonBreech1,EffectorRotationTargetName=LoaderLHCannonBreech1),
                                                                  (Action=DAct_CannonReload_LHOff,IKEnabled=false,PinEnabled=true))),
                                    RightHandIKInfo=(IKEnabled=false,
                                        AlternateEffectorTargets=((Action=DAct_CannonReload_RH1,IKEnabled=false,PinEnabled=false,EffectorLocationTargetName=LoaderRHCannon1,EffectorRotationTargetName=LoaderRHCannon1),
                                                                  (Action=DAct_CannonReload_RH2,IKEnabled=false,PinEnabled=false,EffectorLocationTargetName=LoaderRHCannonMG1,EffectorRotationTargetName=LoaderRHCannonMG1),
    ...
    Begin Object Name=SimObject
        ...
        // WheelSuspensionDamping=75
        // ChassisTorqueScale=0.85
    ...
    VehHitZones(23)=(ZoneName=DRIVERHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=0,SeatProxyIndex=0,CrewBoneName=DriverSeatbone)
    ...
    VehHitZones(25)=(ZoneName=HULLMGHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=3,SeatProxyIndex=2,CrewBoneName=HullMGSeatBone)
    ...
    VehHitZones(27)=(ZoneName=COMMANDERHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=1,SeatProxyIndex=1,CrewBoneName=CommanderSeatBone)
    ...
    VehHitZones(29)=(ZoneName=LOADERHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=4,SeatProxyIndex=3,CrewBoneName=LoaderSeatBone)
    ...
    VehHitZones(31)=(ZoneName=GUNNERHEAD,DamageMultiplier=1.0,VehicleHitZoneType=VHT_CrewHead,CrewSeatIndex=2,SeatProxyIndex=4,CrewBoneName=gunnerSeatBone)
    ...
    ArmorHitZones(30)=(ZoneName=UPPERGUNMANTLET,PhysBodyBoneName=turret,ArmorPlateName=MANLETUP)
    ArmorHitZones(31)=(ZoneName=LOWERGUNMANTLET,PhysBodyBoneName=turret,ArmorPlateName=MANLETDOWN)
    ArmorHitZones(32)=(ZoneName=TURRETFRONT,PhysBodyBoneName=turret,ArmorPlateName=TURRETFRONT)

    ArmorHitZones(33)=(ZoneName=TURRETRIGHTSIDEONE,PhysBodyBoneName=turret,ArmorPlateName=TURRETRIGHT)
    ArmorHitZones(34)=(ZoneName=TURRETRIGHTSIDETWO,PhysBodyBoneName=turret,ArmorPlateName=TURRETRIGHT)
    ArmorHitZones(35)=(ZoneName=TURRETRIGHTSIDETHREE,PhysBodyBoneName=turret,ArmorPlateName=TURRETRIGHT2)


    ArmorHitZones(36)=(ZoneName=TURRETLEFTSIDEONE,PhysBodyBoneName=turret,ArmorPlateName=TURRETLEFT)
    ArmorHitZones(37)=(ZoneName=TURRETLEFTSIDETWO,PhysBodyBoneName=turret,ArmorPlateName=TURRETLEFT)
    ArmorHitZones(38)=(ZoneName=TURRETLEFTSIDETHREE,PhysBodyBoneName=turret,ArmorPlateName=TURRETLEFT2)

    ArmorHitZones(39)=(ZoneName=TURRETREARPLATE,PhysBodyBoneName=turret,ArmorPlateName=TURRETREAR1)
    ArmorHitZones(40)=(ZoneName=TURRETROOFREAR,PhysBodyBoneName=turret,ArmorPlateName=TURRETREAR2)

    ArmorHitZones(41)=(ZoneName=TURRETROOFFRONT,PhysBodyBoneName=turret,ArmorPlateName=TURRETROOF1)
    ArmorHitZones(42)=(ZoneName=COMMANDERHATCH,PhysBodyBoneName=turret,ArmorPlateName=TURRETROOF2)
