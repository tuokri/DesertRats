...
defaultproperties
{
	WeaponContentClass(0)="DesertRats.DRVWeapon_PanzerIVF_Turret_Content"
	SeatIndex=1
	...
	WeaponProjectiles(0)=class'DRVProjectile_PanzerIVF_AP'
	FireInterval(0)=+5.0
	Spread(0)=0.0001
...
//	WeaponFireWaveForm=ForceFeedbackWaveformShooting1
	...
	// Main Gun Ammo
	MainGunProjectiles(MAINGUN_AP_INDEX)=class'DRVProjectile_PanzerIVF_AP'
	MainGunProjectiles(MAINGUN_HE_INDEX)=class'DRVProjectile_PanzerIVF_HE'
	HEAmmoCount=42
	APAmmoCount=42
	SmokeAmmoCount=3
